...
(function () {
  ...
  function doCompare() {
    ...
    $('cmpDiff').textContent = (diff >= 0 ? 'สลากออมสิน (ค่าคาดหวัง) ได้มากกว่า ' : 'เงินฝากประจำได้มากกว่า ') + baht(Math.abs(diff)) + ' ตลอด ' + fmt(r.years, 1) + ' ปี — ผลจริงรายบุคคลจะสุ่มต่างจากค่าคาดหวังนี้ได้มาก';
  }
