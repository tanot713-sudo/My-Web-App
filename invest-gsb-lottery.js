...
(function () {
  ...
  var I18N = {
    th: {
      ...
      headSub: 'ตัวช่วยคิดค่าคาดหวังของสลากออมสินธนาคารออมสิน ไม่ใช่การรับประกันผลตอบแทน',
      ...
      tiersHint: 'กรอกตารางระดับรางวัลจากใบสลาก/เว็บธนาคารออมสินจริง — เพื่อนำมาคำนวณค่าคาดหวัง (ตารางรางวัลเปลี่ยนทุกงวด แอปนี้จึงไม่มีตัวเลขให้ล่วงหน้า)',
      ...
      addBtn: '+ บันทึก',
      lgEmptyDefault: 'ยังไม่มีรายการ — บันทึกทุกครั้งที่ซื้อสลาก จะได้ตารางวันจับรางวัลและติดตามว่างวดไหนถูกรางวัลหรือไม่ (ผลจริงต้องตรวจสอบเองจากธนาคาร/เว็บออมสิน แล้วบันทึกไว้ที่นี่)',
      ...
      lessonSummary: 'เรียนรู้ — สลากออมสินแบบเข้าใจง่าย',
      lsn1h: 'สลากออมสินคืออะไร',
      lsn1p: 'เป็นการฝากเงินรูปแบบหนึ่งที่มีการลุ้นรางวัลแถมมา — ต่างจากหวยทั่วไปตรงที่ <b>ได้เงินต้นคืนเต็มจำนวนเสมอถ้าถือจนครบกำหนด</b> ไม่ว่าจะถูกรางวัลหรือไม่ก็ตาม เป็นสินค้าออมเงินที่มีความเสี่ยงต่ำมาก แต่ผลตอบแทนส่วนใหญ่มาจากโอกาสถูกรางวัลมากกว่าดอกเบี้ยที่มักน้อยมาก',
      ...
      lsn3p: 'สลากออมสินทั่วไป ดอกเบี้ยและเงินรางวัลมักได้รับยกเว้นภาษีเงินได้บุคคลธรรมดา แต่สลากออมสินพิเศษ (สินค้าที่ขายจริงในปัจจุบันหลายรุ่น) อาจถูกหักภาษี ณ ที่จ่ายตามประกาศกรมสรรพากร — ข้อมูลไม่ชัดเจนพอจะฟันธงอัตราเดียวสำหรับทุกรุ่น จึงปรับได้ด้วย checkbox ในการ์ดคำนวณด้านบน',
      lsn4h: 'ทำไมหน้านี้ไม่มีตารางรางวัล/อัตราดอกเบี้ยจริงให้',
      lsn4p: 'ตารางรางวัลและอัตราดอกเบี้ยเปลี่ยนไปแทบทุกงวด/รุ่นที่ธนาคารออมสินออกใหม่ — ใส่ตัวเลขผิดในเครื่องคำนวณกระทบเงินจริงของคุณ จึงให้กรอกจากใบสลากหรือเว็บธนาคารออมสินโดยตรงเสมอ',
      lsn5h: 'ข้อควรระวัง',
    ...
    en: {
      ...
      headSub: 'A tool for thinking about the expected value of Government Savings Bank (GSB) lottery bonds — not a guarantee of returns',
      ...
      tiersHint: "Enter the prize tier table from your lottery bond certificate or the GSB website — used to calculate the expected value (the prize table changes every draw, so this app doesn't provide figures in advance)",
      ...
      addBtn: '+ Log',
      lgEmptyDefault: "No entries yet — log every lottery bond you buy to get a draw schedule and track which draws you've won (real results must be checked yourself from the bank/GSB website, then logged here)",
      ...
      lessonSummary: 'Learn — GSB Savings Lottery Made Simple',
      lsn1h: 'What is a savings lottery bond',
      lsn1p: "A type of deposit with a bonus chance to win prizes — unlike an ordinary lottery, <b>you always get your full principal back if you hold to maturity</b>, whether you win a prize or not. It's a very low-risk savings product, but most of the return comes from the chance of winning rather than the interest, which is usually very small.",
      ...
      lsn3p: 'For regular savings lottery bonds, interest and prizes are usually exempt from personal income tax, but special savings lottery bonds (several series currently on sale) may have withholding tax deducted per Revenue Department notices — the rules aren\'t clear enough to state one single rate for every series, so it can be adjusted with the checkbox in the calculator card above.',
      lsn4h: "Why this page has no real prize table/interest rate",
      lsn4p: "The prize table and interest rate change almost every draw/series that GSB issues — entering the wrong numbers into the calculator would affect your real money, so you're always asked to enter them from your actual certificate or the GSB website directly.",
