...
(function () {
  ...
  var I18N = {
    th: {
      ...
      menuFile: 'ไฟล์', menuEdit: 'แก้ไข', menuView: 'มุมมอง',
      undoLbl: 'เลิกทำ (Ctrl+Z)', redoLbl: 'ทำซ้ำ (Ctrl+Y)', zoomOutLbl: 'ซูมออก', zoomInLbl: 'ซูมเข้า',
    ...
    en: {
      ...
      undoLbl: 'Undo (Ctrl+Z)', redoLbl: 'Redo (Ctrl+Y)', zoomOutLbl: 'Zoom out', zoomInLbl: 'Zoom in',
      clearAll: 'Clear all',
