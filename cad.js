...
(function () {
  ...
  var I18N = {
    th: {
      ...
      toolSectionDraw: 'วาด', toolSectionModify: 'แก้ไข', toolSectionEdit: 'แก้เส้น',
      toolSectionAnnotate: 'ใส่คำอธิบาย', toolSectionInsert: 'แทรก',
      toolSelect: 'เลือก', toolLine: '／ เส้น', toolPolyline: '⌇ พอลีไลน์', toolRect: '▭ สี่เหลี่ยม',
      toolCircle: '○ วงกลม', toolArc: '◜ ส่วนโค้ง', deleteSel: 'ลบที่เลือก',
      zoomFit: 'พอดีจอ', snapToggle: 'สแนปกริด', snapStepLbl: 'ระยะกริด',
      osnapToggle: 'จับจุดวัตถุ', orthoToggle: '⊥ ตั้งฉาก (F8)',
      clearAll: 'ล้างทั้งหมด',
      distLbl: 'ระยะ (มม.)', angLbl: 'มุม (°)', finishPolyline: 'จบเส้นพอลีไลน์',
      preciseHint: 'พิมพ์ระยะแล้วกด Enter (ไม่ใส่มุม = ใช้ทิศทางเมาส์ปัจจุบัน)',
      coordLbl: 'พิกัด:', zoomLbl: 'ซูม:', entCountLbl: 'เอนทิตี้:',
      hintText: 'ลากขวา/กลาง หรือลากด้วยนิ้วเพื่อเลื่อนมุมมอง · หมุนล้อเมาส์/บีบสองนิ้วเพื่อซูม · เลือกเครื่องมือวาดแล้วคลิกจุดตามลำดับ · พิมพ์ตัวเลขได้ทันทีระหว่างวาดเพื่อใส่ระยะเป๊ะ · Shift+คลิกหรือลากคลุมเพื่อเลือกหลายชิ้น · ลากจุดสี่เหลี่ยมบนเอนทิตี้ที่เลือกเพื่อแก้รูปทรงตรงๆ · Esc ยกเลิก · Delete ลบที่เลือก · F8 สลับโหมดตั้งฉาก',
      mmUnit: 'มม.',
      ...
      arrApplyBtn: 'แทรกอาเรย์', arrayHint: 'เลือกเอนทิตี้ก่อน แล้วกำหนดจำนวนแถว/คอลัมน์และระยะห่าง',
      ...
      exportPngBtn: 'PNG', exportSvgBtn: 'SVG', exportDxfBtn: 'DXF', importDxfBtn: 'นำเข้า DXF',
      printBtn: 'พิมพ์/PDF',
      ...
      toolBlock: 'แทรกบล็อก', toolTitleBlock: 'ตารางรายการแบบ',
      blockSizeLbl: 'ขนาดจริง (มม.)', blockRotLbl: 'มุมหมุน (°)', blockMirrorToggle: 'มิเรอร์', blockApplyBtn: 'แทรก',
    ...
    en: {
      ...
      toolSectionDraw: 'Draw', toolSectionModify: 'Modify', toolSectionEdit: 'Edit lines',
      toolSectionAnnotate: 'Annotate', toolSectionInsert: 'Insert',
      toolSelect: 'Select', toolLine: '／ Line', toolPolyline: '⌇ Polyline', toolRect: '▭ Rectangle',
      toolCircle: '○ Circle', toolArc: '◜ Arc', deleteSel: 'Delete selected',
      zoomFit: 'Fit view', snapToggle: 'Grid snap', snapStepLbl: 'Grid step',
      osnapToggle: 'Object snap', orthoToggle: '⊥ Ortho (F8)',
      clearAll: 'Clear all',
      distLbl: 'Distance (mm)', angLbl: 'Angle (°)', finishPolyline: 'Finish polyline',
      ...
      arrApplyBtn: 'Insert array', arrayHint: 'Select entities first, then set rows/columns and spacing',
      ...
      exportPngBtn: 'PNG', exportSvgBtn: 'SVG', exportDxfBtn: 'DXF', importDxfBtn: 'Import DXF',
      printBtn: 'Print/PDF',
      ...
      toolBlock: 'Insert block', toolTitleBlock: 'Title block',
      blockSizeLbl: 'Real size (mm)', blockRotLbl: 'Rotation (°)', blockMirrorToggle: 'Mirror', blockApplyBtn: 'Insert',
