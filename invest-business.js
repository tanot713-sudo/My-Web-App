...
(function () {
  ...
  var I18N = {
    th: {
      ...
      headSub: 'ตัวช่วยประเมินไอเดียธุรกิจ/รายได้เสริม ก่อนลงเงินจริง',
      ...
      lessonSummary: 'เรียนรู้ — ก่อนเริ่มธุรกิจ/รายได้เสริม',
      lsn1h: 'รายได้เสริม vs ธุรกิจหลัก ต่างกันยังไง',
      lsn1p: 'ระดับความเสี่ยง/เวลาที่ทุ่มเทต่างกัน มือใหม่ควรเริ่มเป็นรายได้เสริมคู่กับงานประจำก่อน ค่อยพิจารณาออกมาทำเต็มตัวเมื่อกระแสเงินสดพิสูจน์ตัวเองแล้ว เช่น มีกำไรสม่ำเสมอเกินจุดคุ้มทุนหลายเดือนติดกัน',
      lsn2h: 'จุดคุ้มทุนคำนวณยังไง (ตัวอย่าง)',
      lsn2p: 'ขายเบเกอรี่ ราคา 250 บาท ต้นทุนผันแปร (วัตถุดิบ) 100 บาท → กำไรต่อหน่วย 150 บาท ถ้าต้นทุนคงที่ (ค่าเช่า/ค่าไฟ) 3,000 บาท/เดือน → ต้องขาย 3,000 ÷ 150 = 20 หน่วย/เดือนถึงจะคุ้มทุน — ตัวเลขในเครื่องคำนวณด้านบนมาจากสูตรนี้ และแนะนำให้ขายเผื่อกันชนอย่างน้อย ~20% เหนือจุดคุ้มทุน เพราะยอดขายจริงมักผันผวนกว่าที่คาด',
      lsn3h: 'ทำไมต้องเช็คสัญญาจ้างก่อนเริ่ม',
      lsn3p: 'สัญญาจ้างงานหลายฉบับมีข้อห้ามแข่งขัน (non-compete) ผลประโยชน์ทับซ้อน (conflict of interest) และเงื่อนไขทรัพย์สินทางปัญญา — ถ้าฝ่าฝืนอาจถูกเลิกจ้างหรือฟ้องร้องได้ แม้ธุรกิจจะเล็กแค่ไหนก็ตาม เช็คให้ชัดก่อนเริ่มดีที่สุด',
      lsn4h: 'ความเสี่ยงที่มือใหม่มักมองข้าม',
      lsn4p: 'ประเมินต้นทุนคงที่/เวลาต่ำไปกว่าความจริง · ช่วงขาดสภาพคล่องก่อนถึงจุดคุ้มทุน (มีรายจ่ายแต่ยังไม่มีกำไร) · ความรับผิดส่วนตัวถ้าไม่แยกนิติบุคคล · ภาระภาษีที่ต้องยื่นเพิ่มเมื่อมีรายได้อีกทาง',
      footerDisc: 'ตัวเลขเป็นการประมาณจากสมมติฐานที่กรอก ผลจริงของธุรกิจขึ้นกับตลาดและอาจขาดทุนได้ · ไม่ใช่คำแนะนำการลงทุนหรือกฎหมาย · ข้อมูลเก็บในเครื่องคุณเท่านั้น',
    ...
    en: {
      ...
      headSub: 'A tool to assess a business idea/side income before putting in real money',
      ...
      lessonSummary: 'Learn — Before Starting a Business/Side Income',
      lsn1h: "Side income vs. a main business — what's the difference",
      lsn1p: 'The level of risk/time invested differs — beginners should start as a side income alongside a regular job first, then consider going full-time once cash flow has proven itself, e.g. consistent profit above break-even for several months running',
      lsn2h: 'How the break-even point is calculated (example)',
      lsn2p: 'Selling bakery goods at 250 THB, with a variable cost (ingredients) of 100 THB → profit per unit of 150 THB. If fixed costs (rent/electricity) are 3,000 THB/month → you need to sell 3,000 ÷ 150 = 20 units/month to break even — the figures in the calculator above come from this formula, and it\'s recommended to aim for a buffer of at least ~20% above break-even, since real sales are usually more volatile than expected',
      lsn3h: 'Why you should check your employment contract before starting',
      lsn3p: 'Many employment contracts include non-compete clauses, conflict-of-interest terms, and intellectual property conditions — violating them can lead to termination or a lawsuit, no matter how small the business is. It\'s best to check clearly before you start',
      lsn4h: 'Risks beginners often overlook',
      lsn4p: 'Underestimating fixed costs/time required · a cash-flow gap before reaching break-even (expenses but no profit yet) · personal liability if not incorporated as a separate legal entity · the extra tax filing burden that comes with additional income',
      footerDisc: 'These figures are estimates based on what you enter — actual business results depend on the market and may result in a loss · not investment or legal advice · data is stored on your device only',
